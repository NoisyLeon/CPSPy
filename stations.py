...
class StaLst(object):
    ...
    def read_distfile(self, distfname, network='CPS', lon0=0., lat0=0., lat=0.):
        """
        Read Distance file 
    ...
    def add(self, lon, lat, stacode, network='CPS',  z=0., lon0=0., lat0=0.):
