...
# infname = './syndata_dir_all/Tgr_10.0.txt'
infname = './syndata_dir_all_EX/Tgr_10.0.txt'
infname = './syndata_dir_all_DD/Tgr_10.0.txt'
...
# infname = './syndata_dir_all/Amp_10.0.txt'
infname = './syndata_dir_all_EX/Amp_10.0.txt'
infname = './syndata_dir_all_DD/Amp_10.0.txt'
